...
# readBin("SampleData.csv", "raw", file.info("SampleData.csv")$size) %>% 
#  openssl::base64_encode() -> encoded

# [Download Sample Data](`r sprintf('data:text/csv;base64,%s', encoded)`)
# <a download="SampleData.csv" href="`r sprintf('data:text/csv;base64,%s', encoded)`">Download Sample Data</a>
# [Download .Rmd](`r sprintf('data:text/csv;base64,%s', encoded)`)
```
